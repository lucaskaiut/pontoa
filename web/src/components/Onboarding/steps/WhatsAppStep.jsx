...
export function WhatsAppStep({ onNext, onSkip, onBack }) {
      ...
      <div className="flex gap-3 justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onNext}
            disabled={isConfiguring || isLoading}
            className="bg-linear-to-r from-purple-400 to-blue-500 text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {connectionStatus.connected ? 'Continuar' : 'Continuar sem conectar'}
          </button>
        </div>
      </div>
    </div>
